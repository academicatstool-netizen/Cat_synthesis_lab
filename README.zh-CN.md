...
**把你的文献写成专业的学术文稿 —— 综述、研究计划、申请文书、简历。每条引用都能追溯到真实论文，并在你看到之前就核验完毕。**
...
文体（综述）、论点、论文你都给了——它就**直接开写**（不用填表，只在末尾标一下默认值：APA 7th、约 250 字，方便你之后改）。产出的成品**永远是同一种结构**——正文、参考文献、一段核验声明——换任何大模型来跑都一样：
